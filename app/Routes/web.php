...
$router->get('/admin/roles/nuevo', [RoleController::class, 'create']);
$router->post('/admin/roles', [RoleController::class, 'store']);
$router->get('/admin/roles/{id}/editar', [RoleController::class, 'edit']);
$router->post('/admin/roles/{id}/actualizar', [RoleController::class, 'update']);
$router->post('/admin/roles/{id}/eliminar', [RoleController::class, 'destroy']);
$router->get('/admin/usuarios', [AdminUserController::class, 'index']);
$router->get('/admin/usuarios/nuevo', [AdminUserController::class, 'create']);
...
$router->post('/admin/usuarios/{id}/actualizar', [AdminUserController::class, 'update']);
$router->post('/admin/usuarios/{id}/eliminar', [AdminUserController::class, 'destroy']);
